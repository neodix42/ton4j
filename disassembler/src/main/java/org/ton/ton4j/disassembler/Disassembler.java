...
import org.ton.ton4j.disassembler.consts.KnownMethods;
...
public class Disassembler {
  ...
  public static String decompile(CellSlice cs, Integer indent) {
    ...
    while (cs.getRestBits() > 0) {
      ...
      if (op instanceof String) {
        ...
        String opTxt =
            ((BiFunction<CellSlice, Integer, String>) op).apply(cs, indent != null ? indent : 0);
  ...
  public static String decompileMethodsMap(CellSlice cs, int keyLen, Integer indent) {
    ...
    for (Map.Entry<Integer, String> entry : methodsMapDecompiled.entrySet()) {
      ...
      String methodName =
          KnownMethods.METHODS.get(methodId) == null
  ...
  public static String fromCode(Cell cell) {
    ...
    assert (magic == 0xff00)
        : "Unsupported codepage, magic not equal to 0xff00, found 0x" + Long.toHexString(magic);
