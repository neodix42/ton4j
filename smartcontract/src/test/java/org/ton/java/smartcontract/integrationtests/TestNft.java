...
//        0:3baadb588ca078e8aa270adbd31678f4bafe0bc92afa8e0eaa1f06070b9ba41f
    ...
    public void testNft() {
        ...
        Options optionsNftCollection = Options.builder()
                ...
                .collectionContentBaseUri("http://localhost:63342/nft-marketplace/")
        ...
        log.info("NFT collection address {}", nftCollection.getAddress().toString(true, true, true)); // EQB3XbijQFZ4yWyJluhVkbbbOfv-uBjthjCkv54OHeGIDgxr
...
//        getSingleNftItemInfo(new NftItem(Options.builder().address(nftItem2).build()));
        ...
        NftMarketplace marketplace = new NftMarketplace(Options.builder().adminAddress(adminWallet.getAddress()).build());
        ...
        getStaticData(tonlib, adminWallet, Utils.toNano(0.088), nftItem.getAddress(), 661, adminKeyPair1);
