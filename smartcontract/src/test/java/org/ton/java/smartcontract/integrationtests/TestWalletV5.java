...
public class TestWalletV5 extends CommonTest {
    ...
    public void testWalletV5SimpleJettonTransfer() throws InterruptedException {
        ...
        log.info("walletV5 ({}) balance in jettons {}", walletV5.getAddress().toRaw(), myJettonWallet.getBalance());

        // way second
        BigInteger balance1 = ContractUtils.getJettonBalance(
        ...
        WalletV5Config walletV5Config =
                WalletV5Config.builder()
                        .seqno(newSeq)
                        .walletId(42)
                        .body(walletV5.createBulkTransfer(
                                        Collections.singletonList(
                                                Destination.builder()
                                                        .bounce(true)
                                                        ...
                                                        .body(JettonWallet.createTransferBody(
                                                                ...
                                                                Address.of("0:258e549638a6980ae5d3c76382afd3f4f32e34482dafc3751e3358589c8de00d"), // recipient
        ...
        Utils.sleep(20);
        log.info("walletV5 ({}) balance left in jettons {}", walletV5.getAddress().toRaw(), myJettonWallet.getBalance());
    }
