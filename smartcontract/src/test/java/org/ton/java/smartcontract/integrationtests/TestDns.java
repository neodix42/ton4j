...
//        raw address 0:db80a67a5dddeefaae8fb831db653c05881bf5376f851c826e43cc73776ed7ea
    ...
    public void testDnsResolve() {
        ...
        log.info("rootAddress = {}", rootAddress.toString(true, true, true));
...
//        log.info(addr.toString(true, true, true));
    ...
    public void testDnsRootDeploy() {
        ...
        Wallet rootDnsWallet = new Wallet(WalletVersion.dnsRoot);
        DnsRoot dnsRoot = rootDnsWallet.create();
        ...
        ExternalMessage extMsg = wallet.createTransferMessage(
                ...
                dnsRoot.createStateInit().stateInit
        );
    ...
    public void testDnsCollectionDeploy() {
        ...
        Options optionsDnsCollection = Options.builder()
                ...
                .code(Cell.fromBoc(""))
                .build();
        ...
        log.info("DNS collection address {}", dnsCollection.getAddress().toString(true, true, true)); // EQDjPtM6QusgMgWfl9kMcG-EALslbTITnKcH8VZK1pnH3UZA

        long seqno = wallet.getSeqno(tonlib);

        CellBuilder payload = CellBuilder.beginCell();
        payload.storeUint(0x370fec51, 32);
        payload.storeUint(0, 6);

        ExternalMessage extMsg = wallet.createTransferMessage(
                keyPair.getSecretKey(),
                dnsCollection.getAddress(),
                Utils.toNano(0.5),
                seqno,
                payload,
                (byte) 3, //send mode
                false, //dummy signature
                dnsCollection.createStateInit().stateInit
        );
        ...
        do {
            Utils.sleep(5);
            state = tonlib.getRawAccountState(dnsCollection.getAddress());
        } while (StringUtils.isEmpty(state.getCode()));
...
//                .code(Cell.fromBoc(dnsItemCodeHex))
//                .code(Cell.fromBoc(""))
    ...
    private void getDnsCollectionInfo(DnsCollection dnsCollection) {
        CollectionInfo data = dnsCollection.getCollectionData(tonlib);
        ...
        Address aliceX = dnsCollection.getNftItemAddressByIndex(tonlib, new BigInteger("8b98cad1bf9de7e1bd830ba3fba9608e6190825dddcf7edac7851ee16a692e81", 16)); // "alicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicealicea"
        ...
        log.info(alice3Resolved.toString(true, true, true));
    }

    private void getDnsItemInfo(DnsCollection dnsCollection, DnsItem dnsItem) {
        DnsData data = dnsCollection.getNftItemContent(tonlib, dnsItem);
        log.info("dns data {}", data);
        log.info("collection address {}", data.getCollectionAddress().toString(true, true, true));
        log.info("owner address {}", data.getOwnerAddress().toString(true, true, true));
        ...
        log.info("lastFillUpTime {}", lastFillUpTime);
    }
