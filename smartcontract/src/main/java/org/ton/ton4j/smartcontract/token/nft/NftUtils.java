...
public class NftUtils {
  ...
  public static String parseOnChainUriCell(Cell cell) {
    ...
    TonHashMapE loadedDict =
        cs.loadDictE(256, k -> k.readUint(256), v -> CellSlice.beginParse(v).loadSnakeString());
  ...
  /**
   * The first byte is 0x00 and the rest is key/value dictionary. Key is sha256 hash of string.
