...
public class MyLocalTonFaucet {
  ...
  static String SECRET_KEY = "1bd726fa69d850a5c0032334b16802c7eda48fde7a0e24f28011b22159cc97b7";
  ...
  public static BigInteger topUpContract(
    ...
    WalletV3R2 faucet =
        WalletV3R2.builder().adnlLiteClient(adnlLiteClient).keyPair(keyPair).build();
