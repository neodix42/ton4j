...
@Builder
@Data
public class IndexValue implements Serializable, GlobalIndexValue {
  List<Integer> packages;
  List<Integer> keyPackages;
  List<Integer> tempPackages;

  public static IndexValue deserialize(ByteBuffer buffer) {
  ...
  public static IndexValue deserialize(byte[] data) {
