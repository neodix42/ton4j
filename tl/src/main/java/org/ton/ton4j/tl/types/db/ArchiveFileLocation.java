...
/**
 * Represents the location of a file within an archive package.
 * Contains all information needed to read a file from an archive.
 */
@Data
@Builder
public class ArchiveFileLocation {
   ...
   */
  public static ArchiveFileLocation create(String packagePath, String indexPath, 
                                         String hash, int packageId, long offset) {
