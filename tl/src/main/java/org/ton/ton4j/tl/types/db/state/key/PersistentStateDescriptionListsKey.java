...
@Builder
@Data
public class PersistentStateDescriptionListsKey extends Key {

  public static PersistentStateDescriptionListsKey deserialize(ByteBuffer buffer) {
    return PersistentStateDescriptionListsKey.builder().build();
  }
