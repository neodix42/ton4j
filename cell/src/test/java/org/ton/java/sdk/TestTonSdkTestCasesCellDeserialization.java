...
public class TestTonSdkTestCasesCellDeserialization {
    public static final String numbersTestFileUrl = "https://raw.githubusercontent.com/neodix42/ton-sdk-test-cases/main/cell-deserialization.json";
    ...
    public void testCellDeserialization1() {
        ...
        int expectedLoadUint7 = Integer.parseInt(testCase.getExpectedOutput().get("loadUint7").toString());
    ...
    public void testCellDeserialization2() {
        ...
        Boolean expectedCell1Bits = Boolean.parseBoolean(testCase.getExpectedOutput().get("cell1_bits").toString());
        byte[] expectedCell2Bytes = gson.fromJson(testCase.getExpectedOutput().get("cell2_bytes").toString(), byte[].class);
        byte[] expectedCell5Bytes = gson.fromJson(testCase.getExpectedOutput().get("cell5_bytes").toString(), byte[].class);
        ...
        assertThat(CellSlice.beginParse(cell3InsideCell4).loadAddress()).isEqualTo(expectedAddressCell3);
    ...
    public void testCellDeserialization3() {
        ...
        String convertBackToBocAsBase64 = testCase.getExpectedOutput().get("convertBackToBocAsBase64").toString();
...
//        assertThat(cell.toBase64(true)).isEqualTo(bocAsBase64);
    ...
    public void testCellDeserialization9() {
        ...
        int expectedCellBitLength = Integer.parseInt(testCase.getExpectedOutput().get("cellBitLength").toString());
