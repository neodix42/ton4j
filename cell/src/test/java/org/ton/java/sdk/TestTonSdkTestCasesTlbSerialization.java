...
public class TestTonSdkTestCasesTlbSerialization {
    ...
    public void testTlbSerialization1() {
        ...
        String addr3_std_address_bits256 = testCase.getInput().get("addr3_std_address_bits256").toString();
        ...
        BigInteger addr5_anycast_depth = new BigInteger(testCase.getInput().get("addr5_anycast_depth").toString());
        ...
        String addr5_std_address_bits256 = testCase.getInput().get("addr5_std_address_bits256").toString();
    ...
    public void testTlbSerialization2() {
        ...
        BigInteger shard1PrefixBits = new BigInteger(testCase.getInput().get("shard1_prefix_bits").toString());
        BigInteger shard2Prefix = new BigInteger(testCase.getInput().get("shard2_prefix").toString());
        BigInteger shard2PrefixBits = new BigInteger(testCase.getInput().get("shard2_prefix_bits").toString());
        BigInteger shard3Prefix = new BigInteger(testCase.getInput().get("shard3_prefix").toString());
        BigInteger shard3PrefixBits = new BigInteger(testCase.getInput().get("shard3_prefix_bits").toString());
        ...
        String expectedShard1ChildLeft = testCase.getExpectedOutput().get("shard1_child_left").toString();
        String expectedShard1ChildRight = testCase.getExpectedOutput().get("shard1_child_right").toString();
        BigInteger expectedShard1Parent = new BigInteger(testCase.getExpectedOutput().get("shard1_parent").toString());
        ...
        String expectedShard4ChildLeft = testCase.getExpectedOutput().get("shard4_child_left").toString();
        String expectedShard4ChildRight = testCase.getExpectedOutput().get("shard4_child_right").toString();
        String expectedShard4Parent = testCase.getExpectedOutput().get("shard4_parent").toString();

        //testing
        ShardIdent shard2_4000000000000000 = ShardIdent.builder().shardPrefix(shard2Prefix).prefixBits(shard2PrefixBits.intValue()).build();
        assertThat(shard2_4000000000000000.convertShardIdentToShard().toString(16)).isEqualTo(expectedShard2Hex);
        assertThat(shard2_4000000000000000.getParent().toString(16)).isEqualTo(expectedShard2Parent);

        ShardIdent shard3_c000000000000000 = ShardIdent.builder().shardPrefix(shard3Prefix).prefixBits(shard3PrefixBits.intValue()).build();
        assertThat(shard3_c000000000000000.convertShardIdentToShard().toString(16)).isEqualTo(expectedShard3Hex);
        assertThat(shard3_c000000000000000.getParent().toString(16)).isEqualTo(expectedShard3Parent);

        //root
        ShardIdent shard1_root = ShardIdent.builder().shardPrefix(shard1Prefix).prefixBits(shard1PrefixBits.intValue()).build();
        ...
        //child left/right
        assertThat(shard2_4000000000000000.convertShardIdentToShard().toString(16)).isEqualTo(shard1_root.getChildLeft().toString(16));
        assertThat(shard3_c000000000000000.convertShardIdentToShard().toString(16)).isEqualTo(shard1_root.getChildRight().toString(16));

        ShardIdent shard4_6000000000000000 = ShardIdent.convertShardToShardIdent(shard4PrefixAsHex, 0);
        assertThat(shard4_6000000000000000.getChildLeft().toString(16)).isEqualTo(expectedShard4ChildLeft);
        assertThat(shard4_6000000000000000.getChildRight().toString(16)).isEqualTo(expectedShard4ChildRight);
