...
public class TestCellSlice {
    ...
    public void testCellSlice() {
        ...
        Cell cRef0 = CellBuilder.beginCell()
                .storeUint(1, 3)
                .storeUint(100, 8)
                .endCell();
        Cell cRef1 = CellBuilder.beginCell()
                .storeUint(2, 3)
                .storeUint(200, 8)
                .endCell();
    ...
    public void testCellSliceIntsFromBoc() {
        Cell c4 = Cell.fromHex("0000FF880FFFFFFFFFFFFFFDDC_"); // 0000000000000000 11111111 10001 00000001 1111111111111111111111111111111111111111111111111111111110111011 100
    ...
    public void testCellSliceWith2DictsAndPreload() {
        ...
        TonHashMap loadedDictX = cs.loadDictE(keySizeX,
...
//            assertThat((BigInteger) entry.getValue()).isEqualTo(1 * j);
    ...
    public void testCellSlicePreloadsWishHashMapE() {
        ...
        TonHashMap dictLoaded = cs0.preloadDictE(keySizeX,
                k -> k.readUint(keySizeX),
                v -> CellSlice.beginParse(v).loadUint(8)
        );
        ...
        TonHashMap dictLoadedReal = cs0.loadDictE(keySizeX,
                k -> k.readUint(keySizeX),
                v -> CellSlice.beginParse(v).loadUint(8)
        );
    ...
    public void testCellSlicePreloadsWithHashMap() {
        ...
        TonHashMap dictLoaded = cs0.preloadDict(keySizeX,
                k -> k.readUint(keySizeX),
                v -> CellSlice.beginParse(v).loadUint(8)
        );
