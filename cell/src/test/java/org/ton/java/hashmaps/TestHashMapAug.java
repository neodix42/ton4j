...
public class TestHashMapAug {
    ...
    @Test
    public void testHashMapAugDeserialization() {
    ...
    public void testHashMapAugDeserializationOneEntry() {
        int keySizeX = 9;
    ...
    @Test
    public void testEmptyHashMapAugSerialization() {
        TonHashMap x = new TonHashMap(9);
    ...
    @Test
    public void testHashMapAugDeserializationWithBothEdges() {
    ...
    public void testHashMapAugDeserializationWithMixedEmptyEdges() {
