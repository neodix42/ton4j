...
After successful handshake, client should start authentification, for liteserver any randomly generated key can be used, but for some services specific keys are needed. (example: storage-daemon or validator control).
