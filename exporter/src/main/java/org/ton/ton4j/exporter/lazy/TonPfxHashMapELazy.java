...
/**
 * TonPfxHashMapE with the fixed length keys. With comparison to TonPfxHashMap, TonPfxHashMapE may
 * be empty. The first bit of it is a flag that indicates the emptiness.
 */
public class TonPfxHashMapELazy extends TonPfxHashMapLazy {

  public TonPfxHashMapELazy(int keySize) {
    super(keySize);
  }
