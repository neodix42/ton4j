...
public class TestArchiveDbReader {
  ...
  //    //    blocks1.sort(
  //    //        (o1, o2) -> Long.compare(o2.getBlockInfo().getSeqno(),
  // o1.getBlockInfo().getSeqno()));
  ...
  //    log.info(
  //        "Average time per block: {} ms", String.format("%.2f", (double) durationMs /
  // totalBlocks));
  //  }
  ...
  //    log.info("Parallel loading rate: {} blocks per second", String.format("%.2f",
  // blocksPerSecond));
  //    log.info(
  //        "Average time per block: {} ms", String.format("%.4f", (double) durationMs /
  // totalBlocks));
  //  }
  ...
  // archiveDbReader.getAllBlocksParallel(customThreadCount);
  //
  //    long endTime = System.currentTimeMillis();
  //    long durationMs = endTime - startTime;
  //    double durationSeconds = durationMs / 1000.0;
  ...
  //      } else {
  //        log.info(
  //            "Unknown data type, magic is 0x{} (expected 0x11ef55aa for Block or 0xc3xxxxxx for
  // BlockProof)",
