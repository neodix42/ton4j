...
/**
 * Tests that compare CPU performance between BitString and RealBitString implementations. These
 * tests measure execution time for various operations to determine which implementation is more
 * CPU-efficient.
 */
@Slf4j
...
public class TestBitStringPerformanceCpu {
  ...
  public void testWriteBitPerformance() {
    ...
    for (int i = 0; i < WARMUP_ITERATIONS; i++) {
      ...
      BitString rbs = new BitString(LARGE_SIZE);
    ...
    log.info(
        "BitString write bit average time: {} ns ({} ms)",
        String.format("%.2f", bitStringAvg),
        String.format("%.2f", bitStringAvg / 1_000_000));
    log.info(
        "RealBitString write bit average time: {} ns ({} ms)",
  ...
  public void testReadBitPerformance() {
    ...
    log.info(
        "BitString read bit average time: {} ns ({} ms)",
        String.format("%.2f", bitStringAvg),
        String.format("%.2f", bitStringAvg / 1_000_000));
    log.info(
        "RealBitString read bit average time: {} ns ({} ms)",
        String.format("%.2f", realBitStringAvg),
        String.format("%.2f", realBitStringAvg / 1_000_000));
    log.info(
        "Ratio (BitString/RealBitString): {}",
  ...
  public void testWriteUintPerformance() {
    ...
    for (int i = 0; i < WARMUP_ITERATIONS; i++) {
      ...
      BitString rbs = new BitString(MEDIUM_SIZE * 32);
    ...
    log.info(
        "BitString write uint average time: {} ns ({} ms)",
        String.format("%.2f", bitStringAvg),
        String.format("%.2f", bitStringAvg / 1_000_000));
    log.info(
        "RealBitString write uint average time: {} ns ({} ms)",
        String.format("%.2f", realBitStringAvg),
        String.format("%.2f", realBitStringAvg / 1_000_000));
    log.info(
        "Ratio (BitString/RealBitString): {}",
  ...
  public void testReadUintPerformance() {
    ...
    log.info(
        "BitString read uint average time: {} ns ({} ms)",
        String.format("%.2f", bitStringAvg),
        String.format("%.2f", bitStringAvg / 1_000_000));
    log.info(
        "RealBitString read uint average time: {} ns ({} ms)",
        String.format("%.2f", realBitStringAvg),
        String.format("%.2f", realBitStringAvg / 1_000_000));
    log.info(
        "Ratio (BitString/RealBitString): {}",
  ...
  public void testWriteStringPerformance() {
    ...
    for (int i = 0; i < WARMUP_ITERATIONS; i++) {
      ...
      BitString rbs = new BitString(SMALL_SIZE * 160);
    ...
    log.info(
        "BitString write string average time: {} ns ({} ms)",
        String.format("%.2f", bitStringAvg),
        String.format("%.2f", bitStringAvg / 1_000_000));
    log.info(
        "RealBitString write string average time: {} ns ({} ms)",
        String.format("%.2f", realBitStringAvg),
        String.format("%.2f", realBitStringAvg / 1_000_000));
    log.info(
        "Ratio (BitString/RealBitString): {}",
  ...
  public void testAddressPerformance() {
    ...
    for (int i = 0; i < WARMUP_ITERATIONS; i++) {
      ...
      BitString rbs = new BitString(34 * 8);
  ...
  public void testComplexOperationsPerformance() {
    ...
    // Warm-up
    for (int i = 0; i < WARMUP_ITERATIONS; i++) {
      performComplexOperations(new BitString1(MEDIUM_SIZE * 200), 100);
      // Increase the size here as well to match the test section
      performComplexOperations(new BitString(MEDIUM_SIZE * 200), 100);
    }

    // Test BitString
    long[] bitStringTimes = new long[TEST_ITERATIONS];
    for (int i = 0; i < TEST_ITERATIONS; i++) {
      BitString1 bs = new BitString1(MEDIUM_SIZE * 8);
    ...
    for (int i = 0; i < TEST_ITERATIONS; i++) {
      ...
      BitString rbs = new BitString(MEDIUM_SIZE * 200);
    ...
    log.info(
        "BitString complex operations average time: {} ns ({} ms)",
        String.format("%.2f", bitStringAvg),
        String.format("%.2f", bitStringAvg / 1_000_000));
    log.info(
        "RealBitString complex operations average time: {} ns ({} ms)",
        String.format("%.2f", realBitStringAvg),
        String.format("%.2f", realBitStringAvg / 1_000_000));
    log.info(
        "Ratio (BitString/RealBitString): {}",
  ...
  private void performComplexOperations(BitString rbs, int count) {
  ...
  private void performComplexOperations(BitString1 rbs, int count) {
    for (int i = 0; i < count; i++) {
      rbs.writeUint(i, 32);
      rbs.writeString("Test" + i);
      rbs.writeUint(BigInteger.valueOf(i * 1000), 64);
