...
//        }
    ...
    public boolean[] toBitArray() {
        ...
        for (int i = readCursor; i < writeCursor; i++) { // todo haja
            result[i] = get(i);
        }
        return result;
    }
...
//        System.out.println(Utils.bytesToBitString(ret.array));
//        System.out.println(Utils.bytesToHex(ret.array));
