package org.ton.ton4j.liteclient;
...
import static org.ton.ton4j.liteclient.LiteClient.getGlobalConfigUrlMainnet;
import static org.ton.ton4j.liteclient.LiteClient.getOS;
...
import org.ton.ton4j.liteclient.api.ResultListBlockTransactions;
...
public class LiteClientTest {
  ...
  @Test
  public void testPrintAllMsgInBlock() throws Exception {
    ...
    for (ResultLastBlock shard : shards) {
      ...
      String stdoutDumpblock = liteClient.executeDumpblock(shard);
  ...
  } // shard:(shard_ident shard_pfx_bits:2 workchain_id:0 shard_prefix:0)

  @Test
  public void testPrintAllMsgInMasterBlock() {

    List<Transaction> result = liteClient.getAllTransactionsFromLatestBlock();
  ...
  @Test
  public void testPrintAllMsgInAllShards() {

    LiteClient liteClient = LiteClient.builder().testnet(true).build();

    List<Transaction> result = liteClient.getAllTransactionsFromLatestBlockAndAllShards();
